...
export class Customer extends BusinessObj {
  ...
  setAttrMetaData() {
    ...
    this.attrMetaInfos.push({name:'firstName',dataType:'string',required:true,validVal:'AB',key:false,formField:true,listDisp:true,dispNm:'First Name'});
    this.attrMetaInfos.push({name:'lastName',dataType:'string',required:true,validVal:'AB',key:false,formField:true,listDisp:true,dispNm:'Last Name'});
    ...
    this.attrMetaInfos.push({name:'email',dataType:'string',required:false,validVal:'EM',key:false,formField:true,listDisp:true,dispNm:'email'});
    ...
    this.attrMetaInfos.push({name:'city',dataType:'string',required:false,validVal:'AB',key:false,formField:true,listDisp:true,dispNm:'City'});
    this.attrMetaInfos.push({name:'state',dataType:'string',required:false,validVal:'AB',key:false,formField:true,listDisp:true,dispNm:'State'});      
    this.attrMetaInfos.push({name:'country',dataType:'string',required:false,validVal:'AB',key:false,formField:true,listDisp:true,dispNm:'Country'});
